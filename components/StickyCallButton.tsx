...
export default function StickyCallButton() {
  ...
  useEffect(() => {
    // Show only after scrolling past the hero (≈ 1 viewport height)
    const handleScroll = () => {
    ...
    // Hide when mobile menu is open (Header sets overflow:hidden on body/html)
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-forest-600" aria-hidden="true" />
        </div>
