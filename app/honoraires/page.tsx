      ...
      <section className="section-padding bg-white border-t border-gray-100">
        <div className="section-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              { label: "Droit pénal", href: "/expertises/droit-penal", desc: "Garde à vue, tribunal correctionnel, cour d'assises" },
              { label: "Droit de la famille", href: "/expertises/droit-de-la-famille", desc: "Divorce, garde des enfants, pension alimentaire" },
              { label: "Droit routier", href: "/expertises/droit-routier", desc: "Permis, alcool au volant, excès de vitesse" },
              { label: "Préjudice corporel", href: "/expertises/prejudice-corporel", desc: "Accidents, indemnisation, face aux assureurs" },
              { label: "Droit civil", href: "/expertises/droit-civil", desc: "Contrats, litiges, responsabilité civile" },
