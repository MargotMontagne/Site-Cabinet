  ...
  return (
    <GeoPage
      ...
      intro={[
        ...
        "Cabinet situé à Dunkerque, à environ 1 heure de Boulogne-sur-Mer. Intervention immédiate possible pour les gardes à vue et urgences pénales. Premier contact téléphonique gratuit.",
      ]}
    />
  );
}
